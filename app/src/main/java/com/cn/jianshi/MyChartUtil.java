...
public class MyChartUtil {
    ...
    public static void showChart(Context context, LineChart lineChart, List<String> xDataList,
        ...
        // 标题字体颜色
        lineChart.setDescriptionColor(context.getApplicationContext().getResources().getColor(R.color.colorAccent));
    ...
    private static LineData setLineData(Context context, List<String> xDataList, List<Entry> yDataList,
        ...
        // 显示颜色
        lineDataSet.setColor(context.getApplicationContext().getResources().getColor(R.color.colorPrimaryDark));
        // 圆形的颜色
        lineDataSet.setCircleColor(context.getApplicationContext().getResources().getColor(R.color.colorAccent));
        // 高亮的线的颜色
