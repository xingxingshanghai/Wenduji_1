...
//        mPieChart.setCenterTextSizePixels(5f);
       ...
       // lanyazhishi = (ImageView) findViewById(R.id.lanyazhishi);
        ...
        lishiquxian.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent curveintent = new Intent(MainActivity.this,lineChartActivity.class);
        ...
        public void onScanResult(int callbackType, ScanResult result) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                if(device!=null) {
                    //26:21
                    //26:1F
                    if (device.getName() != null&&device.getAddress().equals("82:EA:CA:10:26:1F")) {  //判断是否已经添加
...
//        }
    ...
    private void displayGattServices(List<BluetoothGattService> gattServices) {
        ...
        gattCharacteristic = gattServices.get(3).getCharacteristics().get(0);
        //gattCharacteristic = gattServices.get(2).getCharacteristics().get(2);
        //get(2)
        ...
        if(gattCharacteristic.getUuid().toString().equals("0000ffe4-0000-1000-8000-00805f9b34fb"))
        {
